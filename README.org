...
** Expansion ideas
   ...
   - Display the playback progress: show the amount of time the song has been playing. One way of implementing this is to have a =Timer= instance that sends a broadcast every seconds that contains the current playback progress.
